...
function ClientsSection() {
  const clients = [
    ...
    { name: 'Studds', logo: '/client-logos/studds.png' },
    ...
    { name: 'Trado Adhesives and Chemicals Pvt. Ltd.', initials: '' },
    { name: 'Calista Salon & Academy', logo: '/client-logos/calista-salon-academy.png', location: 'Ludhiana' },
